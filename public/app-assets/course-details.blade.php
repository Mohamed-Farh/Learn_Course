		      ...
		      <nav id="nav-menu-container">
		        <ul class="nav-menu">
		          ...
		          <li class="menu-has-children"><a href="">Pages</a>
		            <ul>
	              		<li><a href="course-details.blade.php">Course Details</a></li>		
	              		<li><a href="event-details.blade.php">Event Details</a></li>		
			...
			<div class="container">				
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="index.blade.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="courses.blade.php"> Popular Courses</a></p>
					</div>	
				</div>
			</div>
		</section>
                            ...
                            <div class="jq-tab-content-wrapper">
                                ...
                                <div class="jq-tab-content" data-tab="3">
									<ul class="course-list">
										...
										<li class="justify-content-between d-flex">
											<p>Basics of blade.php</p>
											<a class="primary-btn text-uppercase" href="#">View Details</a>
										</li>
										<li class="justify-content-between d-flex">
											<p>Getting Know about blade.php</p>
											<a class="primary-btn text-uppercase" href="#">View Details</a>
										</li>
										<li class="justify-content-between d-flex">
