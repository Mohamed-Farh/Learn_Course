                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('questions.create') }}" class="btn btn-lg btn-primary">{{ __('Add Question') }}</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                                @foreach ($questions as $question)
                                    <tr>
                                        <td title="{{$question->title}}">{{ \Str::limit($question->title, 30) }} 
                                        </td>
                                        ...
                                        <td> 
                                            <a href="/admin/quizzes/{{$question->quiz->id}}"> {{ \Str::limit($question->quiz->title, 30) }} </a>  </td>
