                        ...
                        <form method="post" action="{{ route('courses.update', $course) }}" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Course Title') }}" value="{{$course->title}}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Course Title') }}" value="{{$course->description}}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="link" id="input-link" class="form-control form-control-alternative{{ $errors->has('link') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Course link') }}" value="{{$course->link}}" required>
                                ...
                                <div class="form-group{{ $errors->has('lang') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="lang" required class="form-control">
                                        <option value="0" <?php if($course->lang == 0) echo "selected"; ?> > AR </option>
                                        <option value="1" <?php if($course->lang == 1) echo "selected"; ?> > EN </option>
                                        <option value="2" <?php if($course->lang == 2) echo "selected"; ?> > Other </option>
                                    </select>
                                    @if ($errors->has('lang'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="price" id="input-price" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Course price') }}" value="{{$course->price}}" required min="10.00" step="0.01">
                                ...
                                <div class="form-group{{ $errors->has('track_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="track_id" required class="form-control">
                                        ...
                                        <option 
                                            <?php
                                                if($course->track->id == $track->id)
                                                    echo 'selected'
                                             ?>
                                              value="{{ $track->id }}"> {{ $track->name }} 
                                        </option>
                                        @endforeach
                                    </select>
