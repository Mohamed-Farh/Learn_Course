			...
			<div class="container">				
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="/home">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> </a></p>
					</div>	
				</div>
			</div>
		</section>
			...
			<div class="container">
				...
				<div class="row d-flex justify-content-center">
					<div class="menu-content pb-70 col-lg-8">
						<div class="title text-center">
							<h1 class="mb-10"><span style="color:green; text-align:center;"> ( <u><?php echo count($courses); ?></u> ) </span></h1>
							<h1 class="mb-10">Courses Matches Your Search</h1>
						</div>
					</div>
				</div>	
				...
				<div class="row">
					<div class="col-lg-8 event-details-left">
						<div class="main-img">
							@if($course->photo)	
								<img class="img-fluid" src="/images/courses/{{ $course->photo->filename}}" alt="" style="width:100%; height:min-content;">
							@else
