				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.blade.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="events.blade.php"> Events</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-6 pb-30">
							<div class="single-carusel row align-items-center">
								...
								<div class="detials col-12 col-md-6">
									...
									<a href="event-details.blade.php"><h4>The Universe Through
									A Child S Eyes</h4></a>
									<p>
