            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('argon') }}/img/brand/EYECourses.png">
                        </a>
                    </div>
            ...
            @endif
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#user" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                        <i class="fab fa fa-users" style="color: #f4645f;"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="/admin/tracks">
                        <i class="fa fa-chart-bar text-orange"></i> {{ __('Tracks') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/courses">
                        <i class="fa fa-chalkboard-teacher text-orange"></i> {{ __('Courses') }}
                    </a>
                </li>
                <li class="nav-item"> 
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/quizzes">
                        <i class="fa fa-edit text-orange"></i> {{ __('Quizzes') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/questions">
                        <i class="fa fa-question-circle text-orange"></i> {{ __('Questions') }}
                    </a>
                </li>                
