...
<!-- Favicon-->
<link rel="shortcut icon" href="{{asset('app-assets/img/fav.png')}}">
<!-- Author Meta -->
...
<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
	...
	<link rel="stylesheet" href="{{asset('app-assets/css/jquery-ui.css')}}">			
	<link rel="stylesheet" href="{{asset('app-assets/css/main.css')}}">
	<link rel="stylesheet" href="{{asset('app-assets/css/css.css')}}">